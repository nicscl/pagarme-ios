...
+ (SecKeyRef)addPublicKey:(NSString *)key{
	...
	data = [RSA_pagarme stripPublicKeyHeader:data];
	if(!data){
		return nil;
	}
...
+ (NSString *)encryptString:(NSString *)str publicKey:(NSString *)pubKey{
	...
	return [RSA_pagarme encryptData:data publicKey:pubKey];
}
...
+ (NSString *)encryptData:(NSData *)data publicKey:(NSString *)pubKey{
	...
	SecKeyRef keyRef = [RSA_pagarme addPublicKey:pubKey];
	if(!keyRef){
		return nil;
	}
